...
이 설명서에서는 Azure PowerShell을 위한 새 Az 모듈을 설명합니다. 이 새 모듈은.NET 표준으로 처음부터 작성됩니다. .NET 표준을 사용하면 Azure PowerShell을 Windows의 PowerShell 5 또는 모든 플랫폼의 PowerShell 6에서 실행할 수 있습니다. Az 모듈은 이제 PowerShell을 통해 Azure와 상호 작용하도록 의도된 방법입니다.
...
Azure PowerShell은 Windows의 경우 PowerShell 5.1 이상, 모든 플랫폼의 PowerShell 6 또는 Azure Cloud Shell에서 실행할 수 있습니다.
