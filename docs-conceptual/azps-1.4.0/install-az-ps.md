...
Azure PowerShell은 Windows의 PowerShell 5.1 이상 또는 모든 플랫폼의 PowerShell 6에서 작동합니다.
...
Windows에서 PowerShell 5를 사용하는 경우 .NET Framework 4.7.2도 설치해야 합니다. 새 버전의 .NET Framework를 업데이트 또는 설치하는 방법은 [.NET Framework 설치 설명서](/dotnet/framework/install)를 참조합니다.
